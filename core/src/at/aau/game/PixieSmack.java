...
public class PixieSmack extends ApplicationAdapter {
	...
	public static final int MENU_GAME_WIDTH = 1080; // 1080;
	public static final int MENU_GAME_HEIGHT = 720; // 720;
	public static final int GAME_WIDTH = 15; // 1080;
	public static final int GAME_HEIGHT = 20; // 720;
